...
- Quando você quer executar alguma ação em um componente após um evento em outro componente surgir (Ex: Mudar o label do País para Brasil quando o input receber esse valor). 
